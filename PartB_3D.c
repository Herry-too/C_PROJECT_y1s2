...
void display(void) 
{
	...
	for(t=0; t <= G_t0 && stop_image == 0; t+=0.0005) {
        ...
        if(t-t_delay_rise_1>=0 && t_delay_rise_1>=-0.01 && (G_v0*cos(G_angle_RAD_0)*t) <= (G_d_1-G_v1*cos(G_angle_RAD_1_rise)*(t-t_delay_rise_1))){
            glVertex3f((G_d_1-G_v1*cos(G_angle_RAD_1_rise)*(t-t_delay_rise_1))*5*G_print_fix,10*G_print_fix*(G_v1*sin(G_angle_RAD_1_rise)*(t-t_delay_rise_1)-0.5*g*(t-t_delay_rise_1)*(t-t_delay_rise_1)),(G_d_1-G_v1*cos(G_angle_RAD_1_rise)*(t-t_delay_rise_1))*3*G_print_fix);
        }
        glColor3f(0.5f, 0.9f, 0.5f); //拦截体1最高点
        if(t-t_delay_max_1>=0 && t_delay_max_1>=-0.01 && stop_1_max == 0){
            glVertex3f(5*(G_d_1-G_v1*cos(G_angle_RAD_1_maxheight)*(t-t_delay_max_1))*G_print_fix,10*(G_v1*sin(G_angle_RAD_1_maxheight)*(t-t_delay_max_1)-0.5*g*(t-t_delay_max_1)*(t-t_delay_max_1))*G_print_fix,3*(G_d_1-G_v1*cos(G_angle_RAD_1_maxheight)*(t-t_delay_max_1))*G_print_fix);
        ...
        if(t-t_delay_fall_1>=0 && t_delay_fall_1>=-0.01 && (G_v0*cos(G_angle_RAD_0)*t) <= 3*range(G_v0,G_angle_RAD_0)/4){
            glVertex3f(5*(G_d_1-G_v1*cos(G_angle_RAD_1_fall)*(t-t_delay_fall_1))*G_print_fix,10*(G_v1*sin(G_angle_RAD_1_fall)*(t-t_delay_fall_1)-0.5*g*(t-t_delay_fall_1)*(t-t_delay_fall_1))*G_print_fix,3*(G_d_1-G_v1*cos(G_angle_RAD_1_fall)*(t-t_delay_fall_1))*G_print_fix);
        }
        ...
        if(t-t_delay_rise_2>=0 && t_delay_rise_2>=-0.01 && (G_v0*cos(G_angle_RAD_0)*t) <= (G_d_2-G_v2*cos(G_angle_RAD_2_rise)*(t-t_delay_rise_2))){
            glVertex3f((G_d_2-G_v2*cos(G_angle_RAD_2_rise)*(t-t_delay_rise_2))*5*G_print_fix,10*G_print_fix*(G_v2*sin(G_angle_RAD_2_rise)*(t-t_delay_rise_2)-0.5*g*(t-t_delay_rise_2)*(t-t_delay_rise_2)),(G_d_2-G_v2*cos(G_angle_RAD_2_rise)*(t-t_delay_rise_2))*3*G_print_fix);
        }
        glColor3f(0.0f, 1.0f, 0.0f); //拦截体2最高点
        if(t-t_delay_max_2>=0 && t_delay_max_2>=-0.01 && stop_2_max == 0){
            glVertex3f(5*(G_d_2-G_v2*cos(G_angle_RAD_2_maxheight)*(t-t_delay_max_2))*G_print_fix,10*(G_v2*sin(G_angle_RAD_2_maxheight)*(t-t_delay_max_2)-0.5*g*(t-t_delay_max_2)*(t-t_delay_max_2))*G_print_fix,3*(G_d_2-G_v2*cos(G_angle_RAD_2_maxheight)*(t-t_delay_max_2))*G_print_fix);
        ...
        if(t-t_delay_fall_2>=0 && t_delay_fall_2>=-0.01 && (G_v0*cos(G_angle_RAD_0)*t) <= 3*range(G_v0,G_angle_RAD_0)/4){
            glVertex3f(5*(G_d_2-G_v2*cos(G_angle_RAD_2_fall)*(t-t_delay_fall_2))*G_print_fix,10*(G_v2*sin(G_angle_RAD_2_fall)*(t-t_delay_fall_2)-0.5*g*(t-t_delay_fall_2)*(t-t_delay_fall_2))*G_print_fix,3*(G_d_2-G_v2*cos(G_angle_RAD_2_fall)*(t-t_delay_fall_2))*G_print_fix);
        }
        ...
        if(t-t_delay_rise_3>=0 && t_delay_rise_3>=-0.01 && (G_v0*cos(G_angle_RAD_0)*t) <= (G_d_3-G_v3*cos(G_angle_RAD_3_rise)*(t-t_delay_rise_3))){
            glVertex3f((G_d_3-G_v3*cos(G_angle_RAD_3_rise)*(t-t_delay_rise_3))*5*G_print_fix,10*G_print_fix*(G_v3*sin(G_angle_RAD_3_rise)*(t-t_delay_rise_3)-0.5*g*(t-t_delay_rise_3)*(t-t_delay_rise_3)),(G_d_3-G_v3*cos(G_angle_RAD_3_rise)*(t-t_delay_rise_3))*3*G_print_fix);
        }
        glColor3f(0.1f, 0.5f, 0.1f); //拦截体3最高点
        if(t-t_delay_max_3>=0 && t_delay_max_3>=-0.01 && stop_3_max == 0){
            glVertex3f(5*(G_d_3-G_v3*cos(G_angle_RAD_3_maxheight)*(t-t_delay_max_3))*G_print_fix,10*(G_v3*sin(G_angle_RAD_3_maxheight)*(t-t_delay_max_3)-0.5*g*(t-t_delay_max_3)*(t-t_delay_max_3))*G_print_fix,3*(G_d_3-G_v3*cos(G_angle_RAD_3_maxheight)*(t-t_delay_max_3))*G_print_fix);
        ...
        if(t-t_delay_fall_3>=0 && t_delay_fall_3>=-0.01 && (G_v0*cos(G_angle_RAD_0)*t) <= 3*range(G_v0,G_angle_RAD_0)/4){
            glVertex3f(5*(G_d_3-G_v3*cos(G_angle_RAD_3_fall)*(t-t_delay_fall_3))*G_print_fix,10*(G_v3*sin(G_angle_RAD_3_fall)*(t-t_delay_fall_3)-0.5*g*(t-t_delay_fall_3)*(t-t_delay_fall_3))*G_print_fix,3*(G_d_3-G_v3*cos(G_angle_RAD_3_fall)*(t-t_delay_fall_3))*G_print_fix);
        }
        glEnd();
	    glFlush();
	}
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Project - Herry001 - Part B_3D");
